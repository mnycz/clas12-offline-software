...
public class GridCoordinate {
	...
	/**
	 * Construct a grid coordinate with uniform spacing.
	 *
	 ...
	 * @return an index [0..numPoints-2] such that the grid values at index 
	 * and index+1 enclose the value.
	 */
	 ...
	 * 
	 * @param index the index
	 * @return the minimum for the given index
	 */
	 ...
	 * 
	 * @param index the index
	 * @return the maximum for the given index
	 */
